...
const CartItemBlock: React.FC<CartItemProps> = ( {id, title, imageUrl, price, type, size, count} ) => {
  const dispatch = useDispatch();

  const onClickPlus = () => {
    dispatch(increaseItemsAmount(id))
  }

  const onClickMinus = () => {
    dispatch(decreaseItemsAmount(id))
  }

  const onRemoveItem = () => {
    window.confirm('u really wanna remove this pizza?') && dispatch(removeItem(id))
  }
